...
- (IBAction)addToFavouritesTapped:(id)sender
{
//    user_id  // id of the logged in user
//
    NSDictionary *dict = [NSDictionary dictionaryWithObjectsAndKeys:@"user_id",[UserDefaultsHelper getStringForKey:@"userid"],@"3",@"favourite_user_id",nil];
    [[SSNetworkManager sharedInstance] requestURL:[NSString stringWithFormat:@"%@",DUURL] requestType:@"POST" requestrequestData:dict WithBlock:^(NSDictionary *response, NSError *errorOrNil) {
